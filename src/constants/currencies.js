export const currencies = [
  ...
  { code: 'AFN', symbol: '؋' }, // Afghan Afghani
  { code: 'ALL', symbol: 'L' }, // Albanian Lek
  { code: 'AMD', symbol: '֏' }, // Armenian Dram
  { code: 'ANG', symbol: 'ƒ' }, // Netherlands Antillean Guilder
  ...
  { code: 'BAM', symbol: 'KM' }, // Bosnia and Herzegovina Convertible Mark
  ...
  { code: 'BIF', symbol: 'Fr' }, // Burundian Franc
  { code: 'BMD', symbol: '$' }, // Bermudian Dollar
  { code: 'BND', symbol: '$' }, // Brunei Dollar
  ...
  { code: 'BZD', symbol: '$' }, // Belize Dollar
  { code: 'CAD', symbol: '$' }, // Canadian Dollar
  { code: 'CDF', symbol: 'Fr' }, // Congolese Franc
  ...
  { code: 'CUC', symbol: '$' }, // Cuban Convertible Peso
  { code: 'CUP', symbol: '₱' }, // Cuban Peso
  { code: 'CVF', symbol: 'Esc' }, // Cape Verdean Escudo
  { code: 'CZK', symbol: 'Kč' }, // Czech Koruna
  { code: 'DJF', symbol: 'Fr' }, // Djiboutian Franc
  { code: 'DKK', symbol: 'kr' }, // Danish Krone
  { code: 'DOP', symbol: '$' }, // Dominican Peso
  { code: 'DZD', symbol: 'د.ج' }, // Algerian Dinar
  { code: 'EGP', symbol: 'ج.م' }, // Egyptian Pound
  { code: 'ERN', symbol: 'Nakfa' }, // Eritrean Nakfa
  ...
  { code: 'GNF', symbol: 'Fr' }, // Guinean Franc
  { code: 'GTQ', symbol: 'Q' }, // Guatemalan Quetzal
  { code: 'GYD', symbol: '$' }, // Guyanese Dollar
  ...
  { code: 'IRR', symbol: 'ریال' }, // Iranian Rial
  { code: 'ISK', symbol: 'kr' }, // Icelandic Krona
  { code: 'JMD', symbol: '$' }, // Jamaican Dollar
  { code: 'JOD', symbol: 'د.ا' }, // Jordanian Dinar
  ...
  { code: 'KMF', symbol: 'Fr' }, // Comorian Franc
  ...
  { code: 'LRD', symbol: '$' }, // Liberian Dollar
  { code: 'LSL', symbol: 'M' }, // Lesotho Loti
  { code: 'LTL', symbol: 'Lt' }, // Lithuanian Litas
  { code: 'LVL', symbol: 'Ls' }, // Latvian Lats
  ...
  { code: 'MMK', symbol: 'Ks' }, // Myanmar Kyat
  { code: 'MNT', symbol: '₮' }, // Mongolian Tugrik
  { code: 'MOP', symbol: 'P' }, // Macanese Pataca
  ...
  { code: 'QAR', symbol: 'ر.ق' }, // Qatari Rial
  { code: 'RON', symbol: 'lei' }, // Romanian Leu
  { code: 'RSD', symbol: 'дин' }, // Serbian Dinar
  { code: 'RUB', symbol: '₽' }, // Russian Ruble
  { code: 'RWF', symbol: 'Fr' }, // Rwandan Franc
  ...
  { code: 'STN', symbol: 'Db' }, // São Tomé and Príncipe Dobra
  { code: 'SYP', symbol: 'ل.س' }, // Syrian Pound
  { code: 'SZL', symbol: 'E' }, // Swazi Lilangeni
  { code: 'THB', symbol: '฿' }, // Thai Baht
  { code: 'TJS', symbol: 'SM' }, // Tajikistani Somoni
  { code: 'TMT', symbol: 'm' }, // Turkmenistan Manat
  { code: 'TND', symbol: 'د.ت' }, // Tunisian Dinar
  { code: 'TOP', symbol: 'T$' }, // Tongan Paʻanga
  { code: 'TRY', symbol: '₺' }, // Turkish Lira
  { code: 'TTD', symbol: '$' }, // Trinidad and Tobago Dollar
  { code: 'TWD', symbol: 'NT$' }, // New Taiwan Dollar
  { code: 'TZS', symbol: 'Sh' }, // Tanzanian Shilling
  { code: 'UAH', symbol: '₴' }, // Ukrainian Hryvnia
  { code: 'UGX', symbol: 'Sh' }, // Ugandan Shilling
  { code: 'UYU', symbol: '$' }, // Uruguayan Peso
  { code: 'UZS', symbol: 'лв' }, // Uzbekistani Som
  { code: 'VEF', symbol: 'Bs.F' }, // Venezuelan Bolívar
  { code: 'VND', symbol: '₫' }, // Vietnamese đồng
  { code: 'VUV', symbol: 'Vt' }, // Vanuatu Vatu
  { code: 'WST', symbol: 'T' }, // Samoan Tala
  { code: 'XAF', symbol: 'Fr' }, // Central African CFA franc
  { code: 'XCD', symbol: '$' }, // East Caribbean Dollar
  { code: 'XOF', symbol: 'Fr' }, // West African CFA franc
  { code: 'YER', symbol: 'ر.ي' }, // Yemeni Rial
  { code: 'ZAR', symbol: 'R' }, // South African Rand
  { code: 'ZMW', symbol: 'ZK' }, // Zambian Kwacha
  { code: 'ZWD', symbol: '$' }, // Zimbabwean Dollar
];
